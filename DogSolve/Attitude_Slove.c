                                ...
                                float up_amp,float down_amp,float flight_percent,float freq)
{
    ...
    if(step_length > 45.0f) step_length = 45.0f;
    else if(step_length < -45.0f) step_length = -45.0f;
...
//    usart_printf("%f,%f\r\n",AngleWant_MotorX[1],AngleWant_MotorX[2]);
...
void CartesianToTheta(void)
{
    ...
    TargetAngle1 = TargetAngle1 / 360 * 8;
    TargetAngle2 = TargetAngle2 / 360 * 8;
}
/*
...
DetachedParam state_detached_params[StatesMaxNum] = {
        ...
        {   //walk
                3,
                {16.0f, 7.0f, 4.0f, 0.8f, 0.3f, 2.5f}, //小步子可以迈上去
                {16.0f, 7.0f, 4.0f, 0.8f, 0.3f, 2.5f},
                {16.0f, 7.0f, 4.0f, 0.8f, 0.3f, 2.5f},// 6个参数变量为stance_height; step_length; up_amp; down_amp; flight_percent; freq
                {16.0f, 7.0f, 4.0f, 0.8f, 0.3f, 2.5f}
        },
