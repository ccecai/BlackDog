...
{
    if(local_rc_ctrl->rc.s[1] == 1)
    {
        LieDown_Posture();
    }

    else if(local_rc_ctrl->rc.s[1] == 3 && local_rc_ctrl->rc.ch[0] > -330 && local_rc_ctrl->rc.ch[0] < 330 && local_rc_ctrl->rc.ch[1] > -330 && local_rc_ctrl->rc.ch[1] < 330 && local_rc_ctrl->rc.ch[2] > -330 && local_rc_ctrl->rc.ch[2] < 330 && local_rc_ctrl->rc.ch[3] > -330 && local_rc_ctrl->rc.ch[3] < 330)
    {
        StandUp_Posture();
    }
